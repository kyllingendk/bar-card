...
`;console.info(`%c  BAR-CARD \n%c  ${Me("common.version")} 3.1.7    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");let Ue=class extends he{constructor(){super(...arguments),this._configArray=[],this._stateArray=[],this._animationState=[],this._rowAmount=1}static async getConfigElement(){return document.createElement("bar-card-editor")}static getStubConfig(){return{}}shouldUpdate(e){return ke(this,e,!1)}setConfig(e){if(!e)throw new Error(Me("common.invalid_configuration"));this._config=Se({animation:{state:"off",speed:5},color:"var(--bar-card-color, var(--primary-color))",columns:1,direction:"right",max:100,min:0,positions:{icon:"outside",indicator:"outside",name:"inside",minmax:"off",value:"inside"}},e),"horizontal"==this._config.stack&&(this._config.columns=this._config.entities.length),this._configArray=function(e){const t=[];if(e.entities){for(const i of e.entities)if("string"==typeof i){const n=Se({},e);delete n.entities;const o=Se(n,{entity:i});t.push(o)}else if("object"==typeof i){const n=Se({},e);delete n.entities;const o=Se(n,i);t.push(o)}}else t.push(e);return t}(this._config),this._rowAmount=this._configArray.length/this._config.columns}render(){return this._config&&this.hass?V`
    ...
    `:V``}_createBarArray(){const e=[];for(let t=0;t<this._configArray.length;t++)(e.length+1)*this._config.columns==t&&e.push(this._config.columns),this._configArray.length==t+1&&e.push(this._configArray.length-e.length*this._config.columns);const t=[];for(let i=0;i<e.length;i++){const n=[];for(let t=0;t<e[i];t++){const e=i*this._config.columns+t,o=this._configArray[e],a=this.hass.states[o.entity];if(!a){n.push(V`
            <div class="warning" style="margin-bottom: 8px;">
              ${Me("common.entity_not_available")}: ${o.entity}
            </div>
          `);continue}let r;if(r=o.attribute?a.attributes[o.attribute]:a.state,o.severity&&this._computeSeverityVisibility(r,e))continue;const s=Ae(this.hass,o.max),c=Ae(this.hass,o.min);o.limit_value&&(r=Math.min(r,s),r=Math.max(r,c)),isNaN(Number(r))||(0==o.decimal?r=Number(r).toFixed(0):o.decimal&&(r=Number(r).toFixed(o.decimal)));let l=40;o.height&&(l=o.height);let d,h,p,u="stretch",g="0px 0px 0px 13px",m="right",f="row",v="left",b="height: 100%; width: 2px;";switch(o.direction){case"right":m="right",v="left";break;case"up":g="0px",m="top",f="column-reverse",v="bottom",b="height: 2px; width: 100%;"}switch(p=this._computeSeverityIcon(r,e)?this._computeSeverityIcon(r,e):o.icon?o.icon:a.attributes.icon?a.attributes.icon:_e(me(o.entity),r),o.positions.icon){case"outside":d=V`
              <bar-card-iconbar>
            ...
            `,g="0px";break;case"off":g="0px"}const _=o.name?o.name:a.attributes.friendly_name;let y,$,w,x,S,A,k;switch(o.positions.name){case"outside":y=V`
              <bar-card-name
            ...
            `}switch(w=isNaN(Number(r))?"":o.unit_of_measurement?o.unit_of_measurement:a.attributes.unit_of_measurement,o.positions.minmax){case"outside":x=V`
            ...
            `;break;case"inside":S=V`
              ...
              <bar-card-divider>/</bar-card-divider>
              <bar-card-max> ${s}${w}</bar-card-max>
            `}switch(o.positions.value){case"outside":A=V`
            ...
            `;break;case"inside":k=V`
              <bar-card-value
                ...
                >${o.complementary?s-r:r} ${w}</bar-card-value
              >
            `;break;case"off":g="0px"}let C="";r>this._stateArray[e]?(C="▲","up"==o.direction?this._animationState[e]="animation-increase-vertical":this._animationState[e]="animation-increase"):r<this._stateArray[e]?(C="▼","up"==o.direction?this._animationState[e]="animation-decrease-vertical":this._animationState[e]="animation-decrease"):this._animationState[e]=this._animationState[e],isNaN(Number(r))&&(C="");const E=this._computeBarColor(r,e);let N,O;switch(o.positions.indicator){case"outside":N=V`
              <bar-card-indicator
            ...
            `}const P=this._computePercent(r,e,s,c),T=this._computePercent(o.target,e,s,c);let j=P,I=this._computePercent(o.target,e,s,c);I<j&&(j=I,I=P);let z="";o.width&&(u="center",z=`width: ${o.width}`);const M=this._animationState[e];let R="right",U=100*P,B="animationbar-horizontal";"animation-increase-vertical"!=M&&"animation-decrease-vertical"!=M||(R="bottom",B="animationbar-vertical",U=100*(100-P)),n.push(V`
          <bar-card-card
            style="flex-direction: ${f}; align-items: ${u};"
            @action=${this._handleAction}
            .config=${o}
            .actionHandler=${Pe({hasHold:xe(o.hold_action),hasDoubleClick:xe(o.double_tap_action)})}
          >
            ${d} ${N} ${y}
            <bar-card-background
            ...
            >
              ...
              ${"on"==o.animation.state?V`
                    <bar-card-animationbar
                      style="animation: ${M} ${o.animation.speed}s infinite ease-out; --bar-percent: ${U}%; --bar-color: ${E}; --animation-direction: ${R};"
                      class="${B}"
                    ></bar-card-animationbar>
                  `:""}
              <bar-card-currentbar
